// src/app/page.tsx - Improved version with better mobile display and footer visibility
'use client';
  ...
  return (
    <ViewportController>
      <div className="bg-base-100 text-base-content relative">
        ...
        <section className="relative flex flex-col justify-start items-center p-0 m-0 overflow-hidden h-auto">
          ...
          <section className="relative w-full h-auto mt-8 mb-2">
            ...
            <div className="relative w-full h-auto">
              {/* SVG Background - with media query classes for responsive display */}
              <div 
              ...
              <div 
                className="absolute w-full h-full z-10 pointer-events-none md:hidden" 
                style={{ 
                  top: '10%',
                  left: '-20%',
        ...
        {/* Skills Section */}
        <section className="skills bg-base-100 py-16 px-8 relative z-20">
        ...
        {/* Tech Stack Section */}
        <section className="tech-stack bg-base-200 py-10 relative z-20">
        ...
        <footer className="bg-base-300 py-6 text-center relative z-20 w-full">
